...
public:
    ...
    BlockAdapter(workshop::LibTorchEngine& engine, size_t host_block_size, size_t model_input_size)
        ...
        , m_input(host_block_size + model_input_size)
        , m_output(host_block_size + model_input_size)
    ...
    void process(float* samples, size_t num_samples) {
        ...
        // Whole model blocks only — whatever is left waits for the next call.
        ...
        // silence — that is latency, and step 7 works out how much.
